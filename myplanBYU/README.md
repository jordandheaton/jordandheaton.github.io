...
**Run it:** open `index.html` (no build, no server, no dependencies), then
build a plan in the wizard: pick a major, add any minors and certificates,
enter completed coursework, and say when you want to be done.
